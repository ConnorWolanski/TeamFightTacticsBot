...
class Champions(Enum):
    ...
    # 1 Cost
    DARIUS = Champion("Darius", 1, 600, .5, 50, 1, 25, 20, (Synergies.KNIGHT, Synergies.IMPERIAL))
    ...
    GAREN = Champion("Garen", 1, 600, .55, 55, 1, 35, 20, (Synergies.NOBLE, Synergies.KNIGHT))
    GRAVES = Champion("Graves", 1, 450, .5, 55, 1, 20, 20, (Synergies.PIRATE, Synergies.GUNSLINGER))
    KASSADIN = Champion("Kassadin", 1, 550, .65, 45, 1, 25, 20, (Synergies.SORCERER, Synergies.VOID))
    KHAZIX = Champion("Khazix", 1, 500, .6, 50, 1, 20, 20, (Synergies.VOID, Synergies.ASSASSIN))
    MORDEKAISER = Champion("Mordekaiser", 1, 550, .5, 50, 1, 35, 20, (Synergies.KNIGHT, Synergies.PHANTOM))
    ...
    VAYNE = Champion("Vayne", 1, 550, .65, 45, 3, 20, 20, (Synergies.NOBLE, Synergies.RANGER))
    ...
    BRAUM = Champion("Braum", 2, 750, .6, 40, 1, 25, 20, (Synergies.GLACIAL, Synergies.GUARDIAN))
    ...
    LULU = Champion("Lulu", 2, 500, .6, 50, 2, 25, 20, (Synergies.YORDLE, Synergies.SORCERER))
    PYKE = Champion("Pyke", 2, 600, .6, 60, 1, 25, 20, (Synergies.PIRATE, Synergies.ASSASSIN))
    REKSAI = Champion("Reksai", 2, 650, .65, 40, 1, 20, 20, (Synergies.BRAWLER, Synergies.VOID))
    SHEN = Champion("Shen", 2, 650, .6, 65, 1, 30, 20, (Synergies.NINJA, Synergies.BLADEMASTER))
    ...
    # 3 Cost
    AATROX = Champion("Aatrox", 3, 650, .65, 65, 1, 25, 20, (Synergies.DEMON, Synergies.BLADEMASTER))
    ASHE = Champion("Ashe", 3, 550, .7, 60, 4, 20, 20, (Synergies.RANGER, Synergies.GLACIAL))
    EVELYNN = Champion("Evelynn", 3, 550, .6, 60, 1, 20, 20, (Synergies.ASSASSIN, Synergies.DEMON))
    ...
    RENGAR = Champion("Rengar", 3, 550, .55, 65, 1, 20, 20, (Synergies.WILD, Synergies.ASSASSIN))
    SHYVANA = Champion("Shyvana", 3, 650, .7, 50, 1, 20, 20, (Synergies.DRAGON, Synergies.SHAPESHIFTER))
    VEIGAR = Champion("Veigar", 3, 450, .55, 45, 3, 20, 20, (Synergies.SORCERER, Synergies.YORDLE))
    ...
    AURELION_SOL = Champion("Aurelion Sol", 4, 600, .6, 40, 3, 20, 20, (Synergies.SORCERER, Synergies.DRAGON))
    BRAND = Champion("Brand", 4, 700, .6, 60, 3, 25, 20, (Synergies.DEMON, Synergies.ELEMENTALIST))
    CHOGATH = Champion("Chogath", 4, 1000, .55, 70, 1, 20, 20, (Synergies.BRAWLER, Synergies.VOID))
    DRAVEN = Champion("Draven", 4, 700, .75, 75, 3, 25, 20, (Synergies.IMPERIAL, Synergies.BLADEMASTER))
    GNAR = Champion("Gnar", 4, 750, .7, 45, 2, 30, 20, (Synergies.WILD, Synergies.SHAPESHIFTER, Synergies.YORDLE))
    KINDRED = Champion("Kindred", 4, 600, .65, 55, 3, 20, 20, (Synergies.PHANTOM, Synergies.RANGER))
    LEONA = Champion("Leona", 4, 750, .55, 45, 1, 55, 20, (Synergies.NOBLE, Synergies.GUARDIAN))
    SEJUANI = Champion("Sejuani", 4, 850, .55, 45, 1, 35, 25, (Synergies.KNIGHT, Synergies.GLACIAL))
    # 5 Cost
    ...
    KAYLE = Champion("Kayle", 5, 800, 1.1, 60, 3, 35, 20, (Synergies.KNIGHT, Synergies.NOBLE))
    ...
    YASUO = Champion("Yasuo", 5, 700, 1, 65, 1, 35, 25, (Synergies.EXILE, Synergies.BLADEMASTER))
